...
try {
  ...
  if (process.env.BACKSTOPJS_URL == null || process.env.BACKSTOPJS_REF == null) {
    ...
    module.exports = {
      ...
      scenarios: scenarios,
      paths: {
        bitmaps_reference: "public/_backstop_data/" + scenario + "/bitmaps_reference",
        bitmaps_test: "public/_backstop_data/" + scenario + "/bitmaps_test",
        html_report: "public/_backstop_data/" + scenario + "/html_report",
        ci_report: "public/_backstop_data/" + scenario + "/ci_report",
      },
      report: ["browser", "CI"],
      debug: false,
      engine: "puppeteer",
