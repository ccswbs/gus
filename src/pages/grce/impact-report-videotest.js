...
import EconImpactHumanImpactVideoTest from 'components/blocks/economic-impact/human-impact-videotest';
...
const render = (title) => (
    <Layout>
        ...
        <EconImpactHumanImpactVideoTest />
    </Layout>
)

const EconomicImpactVideoTest = () => (
    render("Economic Impact Report")
)

export default EconomicImpactVideoTest;
