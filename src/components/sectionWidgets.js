...
if (contentExists(props.pageData) && props.pageData.length !== 0) {
    ...
    // - set level heading to start at h2 for grid and list, option to change. 
            ...
            const ctaClassName = contentExists(widgetData.relationships.field_section_column)? "flex-even section-"+widgetData.relationships.field_section_column: '';
            ...
            const statsClassName = contentExists(widgetData.relationships.field_section_column)? "section-"+widgetData.relationships.field_section_column: '';
			return (
            ...
            const leadClassName = contentExists(widgetData.relationships.field_section_column)? "section-"+widgetData.relationships.field_section_column: '';
			return (
