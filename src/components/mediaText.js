...
function MediaText (props) {
	...
	const imageAlt = (contentExists(props.widgetData.relationships.field_media_text_media) ? props.widgetData.relationships.field_media_text_media.field_media_image.alt : `test`);
