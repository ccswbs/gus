...
import data from "../../../data/custom/international/talk_current_student.yml"
...
const InternationalTalkCurrentStudent = ({background}) => {
    return(
...
export default InternationalTalkCurrentStudent;