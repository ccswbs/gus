...
/* Example of a complex content type that:
  ...
  ---
    ...
    type node__contenttypeRelationships implements Node {
      field_image: file__file @link(from:
      field_tags: [relatedTaxonomyUnion] @link(from:
    }
...
changed: Date @dateformat
field_name: [taxonomy_term__vocabulary_name] @link(from: 
...
exports.createSchemaCustomization = ({ actions, schema }) => {
  ...
  const typeDefs = [
    ...
    type media__imageRelationships implements Node {
      ...
      field_tags: [relatedTaxonomyUnion] @link(from: "field_tags.typename" by: "typename")
      node__page: [node__page] @link(from: "node__page.field_hero_image" by: "field_hero_image")
      node__program: [node__program] @link(from: "node__program.field_prog_image" by: "field_prog_image")
    }
    ...
    type node__articleRelationships implements Node {
      field_hero_image: media__image @link(from: "media__image.relationships" by: "relationships")
      field_news_category: [taxonomy_term__news_category] @link(from: "taxonomy_term__news_category.id" by: "id")
      field_tags: [relatedTaxonomyUnion] @link(from: "field_tags.typename" by: "typename")
    }
    ...
    type node__call_to_actionRelationships implements Node {
      field_call_to_action_goal: taxonomy_term__goals @link(from: "taxonomy_term__goals.id" by: "id")
      field_tags: [relatedTaxonomyUnion] @link(from: "field_tags.typename" by: "typename")
    }
    ...
    type node__custom_footerRelationships implements Node {
      field_footer_logo: [media__image] @link(from: "media__image.relationships" by: "relationships")
      field_tags: [relatedTaxonomyUnion] @link(from: "field_tags.typename" by: "typename")
      field_widgets: [widgetParagraphUnion] @link(from: "field_widgets.typename" by: "typename")
    }
    ...
    type node__programRelationships implements Node {
      field_program_acronym: taxonomy_term__programs @link(from: "taxonomy_term__programs.id" by: "id")
      field_courses: [node__course] @link(from: "node__course.id" by: "id")
      field_degrees: [taxonomy_term__degrees] @link(from: "taxonomy_term__degrees.id" by: "id")
      field_program_statistics: [paragraph__program_statistic] @link(from: "paragraph__program_statistic.id" by: "id")
      field_program_variants: [relatedParagraphUnion] @link(from: "field_program_variants.typename" by: "typename")
      field_specializations: [taxonomy_term__specializations] @link(from: "taxonomy_term__specializations.id" by: "id")
      field_tags: [taxonomy_term__tags] @link(from: "taxonomy_term__tags.id" by: "id")
      field_prog_image: media__image @link(from: "media__image.relationships" by: "relationships")
    }
    ...
    type paragraph__accordion_sectionRelationships implements Node {
      field_accordion_block_elements: [paragraph__accordion_block] @link(from: "paragraph__accordion_block.drupal_id" by: "drupal_id")
    } 
    ...
    type paragraph__button_widgetRelationships {
      field_cta_analytics_goal: taxonomy_term__goals @link(from: "taxonomy_term__goals.id" by: "id")
      field_button_style: taxonomy_term__button_styles @link(from: "taxonomy_term__button_styles.id" by: "id")
      field_font_awesome_icon_colour: taxonomy_term__colour_variables @link(from: "taxonomy_term__colour_variables.id" by: "id")
    }
    ...
    type paragraph__call_to_actionRelationships {
      field_call_to_action_goal: taxonomy_term__goals @link(from: "taxonomy_term__goals.id" by: "id")
      field_section_column: taxonomy_term__section_columns @link(from: "taxonomy_term__section_columns.id" by: "id")
    }
    ...
    type paragraph__events_widgetRelationships implements Node {
      field_event_category: [taxonomy_term__event_categories] @link(from: "taxonomy_term__event_categories.id" by: "id")
    }
    ...
    type node__lead_paragraphRelationships implements Node {
      field_lead_para_hero: media__image @link(from: "media__image.relationships" by: "relationships")
      field_section_column: taxonomy_term__section_columns @link(from: "taxonomy_term__section_columns.id" by: "id")
    }
    ...
    type paragraph__links_widgetRelationships implements Node {
      field_link_items: [paragraph__link_item] @link(from: "paragraph__link_item.id" by: "id")
    }
    type paragraph__link_item implements Node {
      drupal_id: String
      field_link_description: String
      field_link_image: media__image @link(from: "media__image.relationships" by: "relationships")
    ...
    type paragraph__link_itemRelationships implements Node {
      drupal_id: String
      paragraph__links_widget: [paragraph__links_widget] @link(from: "paragraph__links_widget.id" by: "id")
      field_link_image: media__image @link(from: "media__image.relationships" by: "relationships")
    }
    ...
    type paragraph__media_textRelationships implements Node {
      field_section_column: taxonomy_term__section_columns @link(from: "taxonomy_term__section_columns.id" by: "id")
      field_media_text_media: media__imagemedia__remote_videoUnion @link(from: "field_media_text_media" by: "field_media_text_media")
      field_button_section: paragraph__section_buttons @link(from: "paragraph__section_buttons.id" by: "id")
    }
    ...
    type paragraph__program_statisticRelationships implements Node {
      field_stat_type: taxonomy_term__statistic_type @link(from: "taxonomy_term__statistic_type.id" by: "id")
    }
    ...
    type paragraph__program_variantsRelationships {
      ...
      field_variant_type: taxonomy_term__program_variant_type @link(from: "taxonomy_term__program_variant_type.id" by: "id")
    }
    ...
    type paragraph__sectionRelationships implements Node {
      field_section_content: [widgetSectionParagraphUnion] @link(from:"field_section_content.typename" by: "typename")
    }
    ...
    type paragraph__section_buttonsRelationships {
      field_section_column: taxonomy_term__section_columns @link(from: "taxonomy_term__section_columns.id" by: "id")
      field_buttons: [paragraph__button_widget] @link(from: "paragraph__button_widget.id" by: "id")
    }
    ...
    type paragraph__section_tabsRelationships {
      field_tabs: [paragraph__tab_content] @link(from:"paragraph__tab_content.id" by: "id")
    }
    ...
    type paragraph__stats_widgetRelationships implements Node {
      field_statistic: [paragraph__program_statistic] @link(from: "paragraph__program_statistic.id" by: "id")
      field_section_column: taxonomy_term__section_columns @link(from: "taxonomy_term__section_columns.id" by: "id")
    }
